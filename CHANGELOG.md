...
- Fix value sort auto-activation after SPA navigation ([#42](https://github.com/mcsdevv/supermarket-unit-value/issues/42)) ([32f5e42](https://github.com/mcsdevv/supermarket-unit-value/commit/32f5e42))
